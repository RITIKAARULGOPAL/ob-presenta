...
export default function EditorPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const saveBanner = saveError ? (
    ...
    <div className="shrink-0 bg-amber-50 px-4 py-2 text-[12px] text-amber-800">
      <strong className="font-semibold">Slides are saving, but the client logo, accent colour and font choice aren&apos;t.</strong>{' '}
      The database is missing those columns — run migrations 0003_add_client_logo.sql and 0004_add_font_family.sql to enable them.
    </div>
  ) : null;
